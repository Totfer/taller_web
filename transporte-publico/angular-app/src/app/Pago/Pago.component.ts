...
export class PagoComponent implements OnInit {
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.usac.transporte.Pago',
      'autobus': this.autobus.value,
      'usuario': this.usuario.value,
      'saldoActual': this.saldoActual.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.autobus) {
        formObject.autobus = result.autobus;
      } else {
        formObject.autobus = null;
      }
      ...
      if (result.saldoActual) {
        formObject.saldoActual = result.saldoActual;
      } else {
        formObject.saldoActual = null;
      }

      if (result.periodo) {
        formObject.periodo = result.periodo;
      } else {
        formObject.periodo = null;
      }

...
export class UsuarioComponent implements OnInit {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.usac.transporte.Usuario',
      'saldo': this.saldo.value,
      'numeroTarjeta': this.numeroTarjeta.value,
      'id': this.id.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.numeroTarjeta) {
        formObject.numeroTarjeta = result.numeroTarjeta;
      } else {
        formObject.numeroTarjeta = null;
      }

...
describe('Starting tests for angular-app', function() {
  ...
  it('network-name should be transporte-publico@0.0.1',() => {
    element(by.css('.network-name')).getWebElement()
    .then((webElement) => {
      return webElement.getText();
    })
    .then((txt) => {
      expect(txt).toBe('transporte-publico@0.0.1.bna');
    });
  });
  ...
  it('navbar-brand should be angular-app',() => {
    ...
    it('Autobus component should be loadable',() => {
      page.navigateTo('/Autobus');
      browser.findElement(by.id('assetName'))
      .then((assetName) => {
        return assetName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('Autobus');
      });
    });

    it('Autobus table should have 3 columns',() => {
      page.navigateTo('/Autobus');
    ...
    it('Usuario table should have 8 columns',() => {
      page.navigateTo('/Usuario');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('Piloto component should be loadable',() => {
      page.navigateTo('/Piloto');
      browser.findElement(by.id('participantName'))
      .then((participantName) => {
        return participantName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('Piloto');
      });
    });

    it('Piloto table should have 10 columns',() => {
      page.navigateTo('/Piloto');
      element.all(by.css('.thead-cols th')).then(function(arr) {
